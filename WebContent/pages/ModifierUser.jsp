	...
	<jsp:include page="header.jsp"/>
		<div class="container">
			...
			<a href="../pages/User.jsp">
				...
				<br>
				<s:actionmessage/>
				<s:form action="UserModifier" namespace="/p" method="modifier">
					<table width="60%" align="center" >
					  <tr>
					    <td>
							<s:textfield name="bean.id" label="ID " cssClass="form-control labelStAj"/>
					    </td>
					  </tr>
					  <tr>
					    <td>
					  ...
					  <td></td>
					    <td align="center">
							<button type="submit" Class="btn btn-success"><i class=" glyphicon glyphicon-ok"></i> Valider la modification</button>
					    </td>
					  </tr>
					</table>
			</s:form>
